...
Output:
  - data/raw/99acres_<city_slug>_localities.json  (with budgetRange filled in)
...
CITY_ZONE_NAMES = json.loads(os.environ.get("CITY_ZONE_NAMES_JSON", "[]") or "[]")
ZONES = CITY_ZONE_NAMES or [
    "North",
    "South",
    "East",
    "West",
...
DATA_FILE = Path(f"data/raw/99acres_{CITY_SLUG}_localities.json")
