...
def main():
    ...
    # Write to JSON
    json_output_path = "data/q4_categorized_hospitals_bangalore.json"
    json_data = []
    ...
    artifact_path = "/Users/malleswararao/.gemini/antigravity-ide/brain/5ad9d68c-7c50-4a98-8496-16e26f027f49/q4_categorized_hospitals.md"
    ...
    with open(artifact_path, "w", encoding="utf-8") as out:
        out.write(f"# Categorized Q4 Premium Hospitals (Bangalore)\n\n")
