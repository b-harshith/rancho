...
def main():
    ...
    artifact_path = "/Users/malleswararao/.gemini/antigravity-ide/brain/5ad9d68c-7c50-4a98-8496-16e26f027f49/q4_categorized_schools.md"
    ...
    with open(artifact_path, "w", encoding="utf-8") as out:
        out.write(f"# Categorized Q4 Schools (Bangalore)\n\n")
    ...
    json_output_path = "data/q4_categorized_schools_bangalore.json"
    json_data = []
    for s in categorized:
        fee_val = float(s["Average Fee (Annual)"])
        stud_val = int(float(s.get("Computed Student Count") or 0))
