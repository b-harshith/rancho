...
OUTPUT_FILE = OUTPUT_DIR / "99acres_locality_boundaries.json"
TEMP_OUTPUT_FILE = OUTPUT_DIR / "99acres_locality_boundaries.jsonl"

NOMINATIM_URL = "https://nominatim.openstreetmap.org/search"
HEADERS = {
    "User-Agent": "BangaloreLocalityBoundaryFetcher/1.0 (contact: harshith_bangalore_research@example.com)"
}
...
def fetch_boundary(locality_name):
    ...
    query = f"{locality_name}, Bangalore, Karnataka, India"
    params = {
        "q": query,
        "format": "json",
        "polygon_geojson": "1",
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data:
                ...
                query_broad = f"{locality_name}, Bangalore, India"
