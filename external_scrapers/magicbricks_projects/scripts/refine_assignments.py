...
def geocode_locality(geolocator, name):
    try:
        # Search with "Bangalore" appended
        query = f"{name}, Bangalore"
...
def main():
    ...
    mapped_path = 'data/processed/bangalore_mapped_data/bangalore_mapped_locality_boundaries.json'
    output_path = 'data/processed/bangalore_mapped_data/bangalore_mapped_locality_boundaries_refined.json'
    ...
    geolocator = Nominatim(user_agent="bangalore_mapper_script")
