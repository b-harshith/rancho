...
def main():
    raw_localities_path = 'data/raw/99acres_bangalore_localities.json'
    mapped_boundaries_path = 'data/processed/bangalore_mapped_data/bangalore_mapped_locality_boundaries.json'
    output_path = 'data/processed/bangalore_mapped_data/bangalore_localities_enriched.json'
