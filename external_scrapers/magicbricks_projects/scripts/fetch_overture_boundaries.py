...
def main():
    ...
    # Bangalore bounding box overlap:
    # Latitude: 12.5 to 13.5
    # Longitude: 77.1 to 78.2
    bbox_filter = """
        bbox.xmin <= 78.2 AND bbox.xmax >= 77.1
        AND bbox.ymin <= 13.5 AND bbox.ymax >= 12.5
    """
    ...
    raw_output = OUTPUT_DIR / "overture_raw_bangalore_divisions.json"
